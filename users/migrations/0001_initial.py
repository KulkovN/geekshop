    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='users_image')),
                ('age', models.PositiveIntegerField(default=18, verbose_name='Возраст')),
                ('activation_key', models.CharField(blank=True, max_length=128)),
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2021, 7, 13, 10, 26, 28, 921876, tzinfo=utc))),
